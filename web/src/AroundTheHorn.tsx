...
import { HeartPulseIcon, SendHorizonalIcon } from "lucide-react";
...
export function PlayerHearts({ players, scores }: { players: User[], scores: { [key: string]: number } }) {
                ...
                return (
                    ...
                    >
                        ...
                        {Array.from({ length: Math.min(score, 5) }, (_, i) => (
                            <HeartPulseIcon key={i} className="text-red-500 fill-white w-4 h-4" />
                        ))}
                                ...
                                >
                                    <div className="absolute inset-0 flex items-center justify-center">
                                        {game.status === "finished" ? (
                                            <Button
                                                onClick={() => navigate(`/games/${game.sport}/around_the_horn/${game.id}/results`)}
                                    ...
                                    <div className="absolute inset-0">
                                        <PlayerHearts players={game.players} scores={game.scores} />
                                    </div>
                                </div>
                            </div>
